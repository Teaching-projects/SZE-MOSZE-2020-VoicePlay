...
TEST(Multest, gainXp100DMG){
    Hero re("Name",1000,Damage(100,0),1,0,1,100,10,10,0.9,0,0,0,2);
...
TEST(Multest, gainXp0DMG){
    Hero re("Name",1000,Damage(0,0),1,0,1,100,10,10,0.9,0,0,0,2);
    unit* u = (new unit("na",200,Damage(1,0),1,0));
    double expected = re.getPDamage();
    double xp = 0;
...
TEST(Multest, gainXp_BigDMG){
    Hero re("Name",1000,Damage(1000,0),1,0,1,100,10,10,0.9,0,0,0,2);
...
TEST(Multest, gainXp_healedAfter){
    Hero re("Name",1000,Damage(10000,0),1,0,1,100,10,10,0.9,0,0,0,2);
    unit* u = (new unit("na",200,Damage(1,0),1,0));
