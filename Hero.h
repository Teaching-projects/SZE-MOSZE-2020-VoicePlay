...
public:
    ...
    Hero(std::string name, double hp, double dmg, double a, double exp, double lvl, double experience_per_level, double health_point_bonus_per_level, double damage_bonus_per_level, double cooldown_multiplier_per_level, double dfs, double dfsbl) 
    ...
    Hero(Hero* l): unit(l->getName(),l->getHealthPoints(),l->getDamage(),
                    ...
                    damage_bonus_per_level(l->damage_bonus_per_level), cooldown_multiplier_per_level(l->cooldown_multiplier_per_level), defense_bonus_per_level(l->defense_bonus_per_level){
                        delete l;
                    }
    //getter fuggvenyek
    double getExp() const;
